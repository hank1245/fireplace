...
export const Scene: React.FC = () => {
  ...
  return (
    <>
      ...
      <LogBench position={[1.2, 0.1, -1.5]} rotation={[0, 0, 0]} />
      <LogBench position={[6, 0.1, -1.5]} rotation={[0, 0, 0]} />
      <LogBench position={[1.8, 0.1, 2.5]} rotation={[0, Math.PI / 2, 0]} />
      <LogBench position={[1.8, 0.1, -2.3]} rotation={[0, Math.PI / 2, 0]} />
